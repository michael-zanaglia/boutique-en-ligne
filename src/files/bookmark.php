            ...
            <?php if($myfavoris):?>
                ...
                <div id='buttons'>
                    ...
                    <button class='btn-fav' name='action' value='add-fav' type='submit'>
                        <svg class="w-6 h-6 taille24 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
