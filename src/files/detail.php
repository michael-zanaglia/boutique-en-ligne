...
<body>
    ...
    <div class='margeAd'>
        <div>
            <input type="hidden" class='id' value='<?=$_GET['id_product']?>'>
            <?php if(isset($_SESSION['user'])):?>
                <input type="hidden" class='user' value='<?=$id_user['id']?>'>
            <?php endif; ?>
        </div>
        <h1>
            <?= $res['name']?>
    ...
    <div class='container-detail'>
        ...
        <div class='bubble'>
            <div class='info-bubble'>
                <p id='qte'>Quantité : <span class='stockTotal'><?= $res['stock'] ?> </span>restante(s)</p>
                <p id='desc'>Description : <?= $res['description']?></p>
                <p id='prix' >Prix : <?= $res['price'] ?> $</p>
            </div>
